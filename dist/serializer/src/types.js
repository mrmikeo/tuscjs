...
Types.public_key = {
  ...
  toObject: function toObject(object, debug) {
    ...
    if (debug.use_default && object === undefined) {
      return _tuscjsWs.ChainConfig.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
    }
...
Types.address = {
  ...
  toObject: function toObject(object, debug) {
    ...
    if (debug.use_default && object === undefined) {
      return _tuscjsWs.ChainConfig.address_prefix + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
    }
